...
const PortfolioCategoryManager = () => {
    ...
    const fetchCategories = async () => {
        ...
        try {
            ...
            let root = allCats.find(c => c.slug === 'portfolio' || c.name.toLowerCase() === 'portfolio');
            if (!root) {
                const createRes = await api.post('/admin/categories', { name: 'Portfolio', parent_id: 0, status: 1, position: 0 });
                    ...
                    <form onSubmit={handleSubmit} className="admin-form-inline">
                        <div className="form-group">
                            ...
                            <input
                                ...
                                required
                                placeholder="e.g. Residential Design or Living Room"
                            />
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            >
                                {portfolioRoot && (
                                    <option value={portfolioRoot.id.toString()}>Main Category</option>
                                )}
                                {categories
                        ...
                        <div className="form-actions">
                            ...
                            {editingId && (
                                <button
                                    ...
                                    onClick={() => {
                                        setEditingId(null);
                                        setFormData({ name: '', parent_id: portfolioRoot ? portfolioRoot.id.toString() : '', status: 1, position: 0 });
                                    }}
                                >
                                    Cancel
                                </button>
                    ...
                    <table className="admin-table">
                        ...
                        <tbody>
                            {loading && categories.length === 0 ? (
                                ...
                                <tr><td colSpan="4" style={{ textAlign: 'center', padding: '40px' }}>No portfolio categories found. Add your first category!</td></tr>
                            ) : (
